function robot_publisher1()
  % Script to move Robot
  % Initialize ROS node
%   rosinit('localhost');


% creat a publisher para aquisição de imagem
camL_pub=rospublisher('/right_camera/image_raw','sensor_msgs/Image');
camL_msg=rosmessage(camL_pub);
