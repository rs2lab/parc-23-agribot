...
RIGHT_VISION_HIGH_LINE=np.array((355, 145))
RIGHT_VISION_LOW_LINE=np.array((165, 145))

LEFT_VISION_HIGH_LINE=np.array((415, 315))
LEFT_VISION_LOW_LINE=np.array((215, 325))
